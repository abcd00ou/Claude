...
```bash
# crontab -e
0 7  * * * cd /Users/idongseong/Claude/AI_SCM && python3 run_daily.py --morning >> /tmp/ai_scm_morning.log 2>&1
0 20 * * * cd /Users/idongseong/Claude/AI_SCM && python3 run_daily.py --evening >> /tmp/ai_scm_evening.log 2>&1
```
